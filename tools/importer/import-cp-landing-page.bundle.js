var CustomImportScript = (() => {
  ...
  var import_cp_landing_page_exports = {};
  __export(import_cp_landing_page_exports, {
    default: () => import_cp_landing_page_default
  });
  ...
  var import_cp_landing_page_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_cp_landing_page_exports);
})();
