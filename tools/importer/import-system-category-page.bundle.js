var CustomImportScript = (() => {
  ...
  // tools/importer/import-system-category-page.js
  var import_system_category_page_exports = {};
  __export(import_system_category_page_exports, {
    default: () => import_system_category_page_default
  });
  ...
  var import_system_category_page_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_system_category_page_exports);
})();
