var CustomImportScript = (() => {
  ...
  var import_services_detail_page_exports = {};
  __export(import_services_detail_page_exports, {
    default: () => import_services_detail_page_default
  });
  ...
  var import_services_detail_page_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_services_detail_page_exports);
})();
